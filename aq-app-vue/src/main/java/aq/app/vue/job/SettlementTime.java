...
public class SettlementTime {
    ...
    protected void execute() throws Exception {
        if(flag){
            ...
            logger.info("============================"+ DateTime.getNowTime("yyyy-MM-dd HH:mm:ss")+" Job任务（统计每月结算订单）开始执行....");
            jobsService.settlement();
            logger.info("============================" + DateTime.getNowTime("yyyy-MM-dd HH:mm:ss") + " Job任务（统计每月结算订单）执行结束....");
            flag = true;
        }
    }
}
